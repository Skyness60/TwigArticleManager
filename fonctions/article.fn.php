...
function getArticles($page, $articlesPerPage) 
{
    $offset = ($page - 1) * $articlesPerPage;
    return array_slice(getEnabledArticles(), $offset, $articlesPerPage);
}
...
{
    return count(getEnabledArticles());
}
